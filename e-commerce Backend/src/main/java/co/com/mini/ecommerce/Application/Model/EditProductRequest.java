...
public class EditProductRequest implements ApplicationRequest {
    ...
    public EditProductRequest(int identificationNumber, String name, String description, double base_Price, double tax_Rate, String productstatus, int inventory) {
